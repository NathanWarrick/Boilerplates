...
unxz fedora-coreos-39.20231119.3.0-qemu.x86_64.qcow2.xz

virt-customize -a fedora-coreos-39.20231119.3.0-qemu.x86_64.qcow2 --install qemu-guest-agent,nano
sleep 2
virt-sysprep --operations machine-id -a fedora-coreos-39.20231119.3.0-qemu.x86_64.qcow2

qm create 9020 --memory 2048 --core 2 --name fedora-coreos--$(date +%d-%m-%Y) --net0 virtio,bridge=vmbr1  --pool Templates
qm importdisk 9020 fedora-coreos-39.20231119.3.0-qemu.x86_64.qcow2 disks
sleep 5
...
rm fedora-coreos-39.20231119.3.0-qemu.x86_64.qcow2
