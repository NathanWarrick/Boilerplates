...
qm create 9004 --memory 2048 --core 2 --name ubuntu-20.04-LTS-Minimal--$(date +%d-%m-%Y) --net0 virtio,bridge=vmbr1  --pool Templates
...
qm disk move 9004 scsi0 disks --format qcow2 --delete
