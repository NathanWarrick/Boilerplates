...
qm create 9003 --memory 2048 --core 2 --name ubuntu-20.04-LTS --net0 virtio,bridge=vmbr1
...
virt-customize -a /mnt/pve/disks/images/9003/vm-9003-disk-0.raw --install qemu-guest-agent,nano
